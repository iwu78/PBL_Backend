...
def initSongs():
    ...
    {'name':'Sensei Wu', 'url':'/audios/WU.mp3', 'description':' Ian Wu Father ', 'uri':'https://static.wikia.nocookie.net/ninjago/images/1/14/TalesWu.png/revision/latest/scale-to-width-down/250?cb=20190125043845', 'tokens':'3'},
